...
import ru.job4j.car.repository.brand.HibernateBrandRepository;
...
public class BrandRepositoryTest {
    private final BrandRepository brandRepository = new HibernateBrandRepository(crudRepository);
